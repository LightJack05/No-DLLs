...
void CreateRubberBall()
{
    ...
    collider->color_b = (rand() % 255);
    collider->color_r = (rand() % 255);
    collider->color_g = (rand() % 255);
    collider->width = 50;
    collider->height = 50;
    collider->position_x = rand() % 200;
    collider->position_y = rand() % 200;
    collider->velocity_x = (rand() % 1000) / (double)3000;
    collider->velocity_y = (rand() % 1000) / (double)3000;
